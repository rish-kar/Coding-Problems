...
## Problem Overview
You are given the head of a sorted linked list, delete all nodes that have duplicate numbers, leaving only distinct numbers from the original list . Then return the linked list sorted as well .
